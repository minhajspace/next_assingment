...
function (_React$Component) {
  ...
  function App() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "onButtonPress", function (e) {
      ...
      if (_this.state.userInput === _this.state.password && _this.state.userInput.includes("@")) {
        console.log("you are no next page");
      } else if (_this.state.password !== _this.state.userInput) {
        _this.setState({
          errorPassword: "involid password"
        });
      } else {
        _this.setState({
...
//# sourceMappingURL=index.js.5e07c69ab11b840b5b23.hot-update.js.map